    ...
    class 등록 {
        ...
        void 취향_진단_결과를_등록한다() throws Exception {
            ...
            mockMvc.perform(post("/propensity")
                ...
                .andExpect(jsonPath("$.data.propensityResult.code").value(PropensityResponseFixture.CODE))
                .andExpect(jsonPath("$.data.propensityResult.imageUrl").value(PropensityResponseFixture.IMAGE_URL))
