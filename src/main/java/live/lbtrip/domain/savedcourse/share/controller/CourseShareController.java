...
public class CourseShareController implements CourseShareApi {
    ...
    public ResponseEntity<SharedCourseDetailResponse> getSharedCourseDetail(
        @PathVariable String token
    ) {
        SharedCourseDetailResponse response = courseShareService.getSharedCourseDetail(token);
