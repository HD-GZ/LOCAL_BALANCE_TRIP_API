    ...
    static String html(String code) {
        return """
            ...
            <head>
              ...
              <title>로컬밸런스 트립 이메일 인증</title>
            </head>
            <body style="margin:0;padding:0;background-color:#f3f5f7;color:#1f2937;\
            font-family:Arial,'Apple SD Gothic Neo','Noto Sans KR',sans-serif;">
              <div style="display:none;max-height:0;overflow:hidden;opacity:0;">
                회원가입을 위한 이메일 인증번호를 확인해 주세요.
              </div>
            ...
            style="width:100%%;background-color:#f3f5f7;">
                <tr>
                  <td align="center" style="padding:40px 16px;">
                    <table role="presentation" width="100%%" cellspacing="0" cellpadding="0" border="0" \
            style="width:100%%;max-width:560px;background-color:#ffffff;border:1px solid #e5e7eb;\
            border-radius:16px;">
                      <tr>
                        <td style="padding:36px 36px 20px;">
                          <p style="margin:0;font-size:15px;font-weight:700;letter-spacing:-0.2px;\
            color:#2563eb;">
                            LOCAL BALANCE TRIP
                          </p>
                          <h1 style="margin:18px 0 12px;font-size:26px;line-height:1.4;\
            letter-spacing:-0.7px;color:#111827;">
                            이메일 인증번호를<br>안내드립니다
                          </h1>
                      ...
                      <tr>
                        <td style="padding:4px 36px 28px;">
                          <div style="padding:24px;text-align:center;background-color:#eff6ff;\
            border:1px solid #dbeafe;border-radius:12px;">
                            <p style="margin:0 0 10px;font-size:13px;font-weight:700;color:#2563eb;">
                              인증번호
                            </p>
                            <p style="margin:0;font-family:'Courier New',monospace;font-size:36px;\
            line-height:1.2;font-weight:700;letter-spacing:8px;color:#111827;">
                              %s
                            </p>
                          </div>
                        </td>
                    ...
                    <p style="margin:18px 0 0;font-size:12px;line-height:1.6;color:#9ca3af;">
                      이 메일은 발신 전용입니다. © Local Balance Trip
                    </p>
                  </td>
                </tr>
              </table>
