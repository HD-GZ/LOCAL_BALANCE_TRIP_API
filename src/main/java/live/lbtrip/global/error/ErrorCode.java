...
public enum ErrorCode {
    ...
    TOUR_API_QUOTA_EXCEEDED(HttpStatus.SERVICE_UNAVAILABLE, "관광 정보 API 일일 요청 한도를 초과했습니다."),
    TOUR_DATA_NOT_READY(HttpStatus.SERVICE_UNAVAILABLE, "관광 데이터가 아직 준비되지 않았습니다."),
    TOUR_SYNC_IN_PROGRESS(HttpStatus.CONFLICT, "관광 데이터 동기화가 이미 실행 중입니다."),
    ...
    INCENTIVE_REGION_INVALID(HttpStatus.BAD_REQUEST, "존재하지 않는 지역입니다."),
