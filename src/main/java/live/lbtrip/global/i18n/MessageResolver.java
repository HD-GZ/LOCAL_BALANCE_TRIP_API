...
public class MessageResolver {
    ...
    public String resolveEnum(Enum<?> value) {
        return resolve(enumKey(value));
    }

    public String resolveEnum(Enum<?> value, String variant) {
        return resolve(enumKey(value) + "." + variant);
    }

    private String enumKey(Enum<?> value) {
        return ENUM_PREFIX + value.getDeclaringClass().getSimpleName() + "." + value.name();
    }
}
